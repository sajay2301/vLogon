    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // getTasks()
        ...
        if(edit.equals("true")) {
            ...
            currentlyworkingornot = i.getBoolean("currentlyworkingornot")
            id = i.getInt("id")
            btnsave.text = "Update"
            ...
            checkBoxalowsendnewsoffer.isChecked = currentlyworkingornot
            ...
            override fun doInBackground(vararg params: String): String? {
                ...
                if (database.experienceDao().all.isEmpty()) {
                  ...
                  /*  } else {
                        ...
                        AppDatabase.getInstance(this@ExperienceActivity).experienceDao().update(etcompany.text.toString(), ettitle.text.toString(),etlocation.text.toString(), etstartdate.text.toString(),etenddate.text.toString(), etdescroption.text.toString(),currentyworkornot,mSessionHolder.User_Login,mSessionHolder.Source_login)
