...
class ExpandableListAdapter(var context: Context, var expandableListView: ExpandableListView, var itemListheader: ArrayList<ContactListItem>) : BaseExpandableListAdapter() {
    ...
    override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup?): View? {
        ...
        ivContactImage.setOnClickListener {
            ...
            //Toast.makeText(context, itemListheader[groupPosition].catName,Toast.LENGTH_SHORT).show()
        }

        //Log.e("name", itemListheader[groupPosition].catName)
        ivContactImage.setOnClickListener {
            if (expandableListView.isGroupExpanded(groupPosition))
                expandableListView.collapseGroup(groupPosition)
            else
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, convertView: View?, parent: ViewGroup?): View? {
        ...
        llshareContact.setOnClickListener {
            ...
            ShareCompat.IntentBuilder
                .from(context as Activity?) // getActivity() or activity field if within FragNewsPagerItem
