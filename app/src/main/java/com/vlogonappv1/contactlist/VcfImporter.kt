...
import com.vlogonappv1.extensions.getCachePhoto
import com.vlogonappv1.extensions.getCachePhotoUri
import com.vlogonappv1.extensions.normalizeNumber
...
class VcfImporter(val activity: AddressBookActivity) {
    ...
    fun importContacts(path: String, targetContactSource: String): ImportResult {
        try {
            ...
            for (ezContact in ezContacts) {
                ...
                Log.e("phoneNumbers",phoneNumbers.toString())
                contactsImported++
